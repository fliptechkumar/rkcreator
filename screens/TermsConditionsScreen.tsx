...
export default function TermsConditionsScreen({ navigation }: Props) {
  ...
  const GetTermsConditions = async () => {
    try {
      ...
      const response = await fetch(`${API_ENDPOINTS.TERMS_CONDITIONS}?id=${userId}`, {
        method: 'GET',
        headers: {
      ...
      console.log('Terms & Conditions Response Data:', responseData);
      if (responseData && responseData.data) {
        setTermsContent(responseData.data);
      }
      setLoading(false);
    } catch (error: any) {
      setLoading(false);
      ...
      alert(`Error: ${error.message || 'Failed to fetch terms and conditions'}`);
    }
  };
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          ...
          {/* <View style={styles.introSection}>
            ...
            <Text style={styles.introText}>
              {termsContent?.title || 'Please read these terms and conditions carefully before using our services. These terms govern your use of Nezlan Jewellery\'s platform and services.'}
            </Text>
            <Text style={styles.lastUpdated}>Effective Date: January 1, 2026</Text>
          </View> */}
